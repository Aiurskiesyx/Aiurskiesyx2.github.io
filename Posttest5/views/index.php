  ...
  <main>
    ...
    <div class="content" id="content">
      ...
      <div class="content-card">
        <div class="card">
          <div class="card-img">
            <img src="../assets/Furry Kitty Troop on the Prowl.jpeg" alt="" />
          </div>
          <h2 class="card-title">4 baby kittens</h2>
          <h3 class="card-title">All baby kittens don't have names until now <br> 3 males and 1 female <br> Need a
            forever home</h3>
          <button class="btn">MORE</button>
        </div>
        <div class="card">
          <div class="card-img">
            <img src="../assets/cute (1).jpeg" alt="" />
          </div>
          <h2 class="card-title">Tobby</h2>
          <h3 class="card-title">Most handsome cat<br>Has a warm heart and loves to cuddle <br> Besides that he really
            likes to sleep</h3>
          <button class="btn">MORE</button>
        ...
        <div class="card">
          <div class="card-img">
            <img src="../assets/twins.jpeg" alt="" />
          </div>
          <h2 class="card-title">Miko & Miki</h2>
          <h3 class="card-title"> Playful twins cat <br>Found in the rubble of a burning house</h3>
          <button class="btn">MORE</button>
