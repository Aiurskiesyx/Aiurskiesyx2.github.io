<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "UPDATE kucing SET nama='$nama', umur='$umur', deskripsi='$deskripsi', picture='$picture' WHERE id=$id";
    ...
    <section class="update-content">
        <div class="update-form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="deskripsi" value="<?php echo $deskripsi ?>" class="textfield">
